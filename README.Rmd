...
hash tag reads, arguing that cell intrinsic factors also play a role. `HTODemux`
currently does not consider this source of bias and could benefit from doing so.
In conclusion, neither strategy seems optimal currently.
